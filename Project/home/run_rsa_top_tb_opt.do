...
vlog -sv ./src/tb/csa_tb.sv +incdir+./src
vlog -sv ./src/tb/final_adder_tb.sv +incdir+./src
vlog -sv ./src/tb/mod_exp_tb.sv +incdir+./src
vlog -sv ./src/tb/mod_exp_tb_2.sv +incdir+./src
vlog -sv ./src/tb/mod_exp_tb_3.sv +incdir+./src
vlog -sv ./src/tb/mont_mult_tb.sv +incdir+./src
vlog -sv ./src/tb/rsa_top_tb.sv +incdir+./src
vlog -sv ./src/tb/bit_comp_tb.sv +incdir+./src
vlog -sv ./src/tb/bit_shift_adder_tb.sv +incdir+./src
vlog -sv ./src/tb/counter_tb.sv +incdir+./src
vlog -sv ./src/tb/counter_to_t_sub_1_tb.sv +incdir+./src
vlog -sv ./src/tb/csa_5_to_2_div_2_tb.sv +incdir+./src
