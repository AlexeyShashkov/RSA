onerror {resume}
quietly virtual signal -install /rsa_top_tb/dut {/mspa_top/mspa_upf_top/mspaScope3_rsa_top_tb/mspaScope1_dut/GND  } GND
quietly virtual signal -install /rsa_top_tb/dut {/mspa_top/mspa_upf_top/mspaScope3_rsa_top_tb/mspaScope1_dut/VDD  } VDD
quietly virtual signal -install /rsa_top_tb/dut {/mspa_top/mspa_upf_top/mspaScope3_rsa_top_tb/mspaScope1_dut/sw_vdd_n  } sw_vdd_n
quietly virtual signal -install /rsa_top_tb/dut {/mspa_top/mspa_upf_top/mspaScope3_rsa_top_tb/mspaScope1_dut/gnd_n  } gnd_n
quietly virtual signal -install /rsa_top_tb/dut {/mspa_top/mspa_upf_top/mspaScope3_rsa_top_tb/mspaScope1_dut/vdd_n  } vdd_n
quietly virtual signal -install /rsa_top_tb/dut {/mspa_top/mspa_upf_top/mspaScope3_rsa_top_tb/mspaScope1_dut/mspa5_sw_pwr_ss_PS_mspa_obj  } sw_pwr_ss
quietly virtual signal -install /rsa_top_tb/dut {/mspa_top/mspa_upf_top/mspaScope3_rsa_top_tb/mspaScope1_dut/mspa6_pwr_ss_PS_mspa_obj  } pwr_ss
quietly virtual signal -install /rsa_top_tb/dut {/mspa_top/mspa_upf_top/mspaScope3_rsa_top_tb/mspaScope1_dut/mspa24_PD_top/PD_top_mspa_obj  } PD_top
quietly virtual signal -install /rsa_top_tb/dut {/mspa_top/mspa_upf_top/mspaScope3_rsa_top_tb/mspaScope1_dut/mspa26_PD_sw/PD_sw_mspa_obj  } PD_sw
quietly virtual region /rsa_top_tb/dut SW  
quietly virtual signal -install /rsa_top_tb/dut/SW {/mspa_top/mspa_upf_top/mspaScope3_rsa_top_tb/mspaScope1_dut/mspa6_pwr_ss_PS_mspa_obj  } supply
quietly virtual signal -install /rsa_top_tb/dut/SW {/mspa_top/mspa_upf_top/mspaScope3_rsa_top_tb/mspaScope1_dut/mspa30_SW/PWR  } PWR
quietly virtual signal -install /rsa_top_tb/dut/SW {/mspa_top/mspa_upf_top/mspaScope3_rsa_top_tb/mspaScope1_dut/mspa30_SW/GND  } GND
quietly virtual signal -install /rsa_top_tb/dut/SW {/mspa_top/mspa_upf_top/mspaScope3_rsa_top_tb/mspaScope1_dut/mspa30_SW/SW_IN  } SW_IN
quietly virtual signal -install /rsa_top_tb/dut/SW {/mspa_top/mspa_upf_top/mspaScope3_rsa_top_tb/mspaScope1_dut/mspa30_SW/SW_OUT  } SW_OUT
quietly virtual signal -install /rsa_top_tb/dut/SW {/mspa_top/mspa_upf_top/mspaScope3_rsa_top_tb/mspaScope1_dut/mspa30_SW/SW_DIS  } SW_DIS
...
add wave -noupdate -group rsa_power_control_0 /rsa_top_tb/dut/rsa_power_control_0/clk
add wave -noupdate -group rsa_power_control_0 /rsa_top_tb/dut/rsa_power_control_0/ce
add wave -noupdate -group rsa_power_control_0 /rsa_top_tb/dut/rsa_power_control_0/rst
add wave -noupdate -group rsa_power_control_0 /rsa_top_tb/dut/rsa_power_control_0/req_enable
add wave -noupdate -group rsa_power_control_0 /rsa_top_tb/dut/rsa_power_control_0/req_disable
add wave -noupdate -group rsa_power_control_0 -color Magenta -itemcolor Magenta /rsa_top_tb/dut/rsa_power_control_0/sw_ack
add wave -noupdate -group rsa_power_control_0 /rsa_top_tb/dut/rsa_power_control_0/outputs_force_zero
add wave -noupdate -group rsa_power_control_0 -color Cyan -itemcolor Cyan /rsa_top_tb/dut/rsa_power_control_0/iso_en
add wave -noupdate -group rsa_power_control_0 /rsa_top_tb/dut/rsa_power_control_0/sw_disable
add wave -noupdate -group rsa_power_control_0 -color Cyan -itemcolor Cyan /rsa_top_tb/dut/rsa_power_control_0/reset_on_enable
add wave -noupdate -group rsa_power_control_0 /rsa_top_tb/dut/rsa_power_control_0/mode_change_ack
add wave -noupdate -group rsa_power_control_0 /rsa_top_tb/dut/rsa_power_control_0/present_state
add wave -noupdate -group rsa_power_control_0 /rsa_top_tb/dut/rsa_power_control_0/next_state
